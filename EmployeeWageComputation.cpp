...
struct CompanyEmpWage
{
    ...
    void EmpWageBuilder(string companyName, int wagePerHour, int workingDaysPerMonth, int maximumWorkingHours, int employees, int months)
    {
...
int main()
{
    ...
    empWage[0].EmpWageBuilder("abc", 15, 20, 120, 3, 2);
    empWage[0].calculate();
    empWage[1].EmpWageBuilder("xyz", 20, 20, 150, 2, 3);
    empWage[1].calculate();
    return 0;
}